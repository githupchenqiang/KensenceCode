...
//    imagevi.backgroundColor = [UIColor orangeColor];
    ...
    view.frame = CGRectMake(KscreenWidth/3.2,  KscreenHeight/3.6, KscreenWidth/2.7, KscreenHeight/2);
    view.backgroundColor = [UIColor whiteColor];
    view.layer.shadowColor = [UIColor grayColor].CGColor;//阴影的颜色
    view.layer.shadowOpacity = 2.6f; // 阴影透明度
    view.layer.shadowOffset = CGSizeMake(0.0, 3.0f); // 阴影的范围
    view.layer.shadowRadius = 3.0;// 阴影扩散的范围控制
    ...
    [self.view addSubview:Nav.view];
        ...
        //创建输入框
    _text4ip  = [[UITextField alloc]initWithFrame:CGRectMake(KscreenWidth/3, KscreenHeight/3.2, KscreenWidth/3,52)];
