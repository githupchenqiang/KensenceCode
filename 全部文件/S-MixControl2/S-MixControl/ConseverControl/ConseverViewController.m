...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    for (int i = 0; i < [SignalValue ShareValue].GetMessage.count; i++) {
        ...
        NSString *Key = [NSString stringWithFormat:@"%ld",i+300+115*[SignalValue ShareValue].ProCount + 115*[SignalValue ShareValue].Integer/9];
...
//            
//            UILabel *label = [self.view viewWithTag:2000+i];
//            
//            label.text = @"";
//            
//        }
...
//            NSString *strVale = [NSString stringWithFormat:@"%d",i+2000];
