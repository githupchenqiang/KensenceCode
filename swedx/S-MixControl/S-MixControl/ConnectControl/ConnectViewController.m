...
- (void)viewDidLoad {
   ...
   view .backgroundColor = [UIColor colorWithRed:24/255.0 green:33/255.0 blue:40/255.0 alpha:1];
   [self.view addSubview:view];
    
    UIImageView *LogImageView = [[UIImageView alloc]initWithFrame:CGRectMake(15, KscreenHeight /4, 400, 400)];
    UIImage *logImage = [UIImage imageNamed:@"swedxUKicon"];
    ...
    Telephone.text = NSLocalizedString(@"Phone：0333 987 5310",@"");
    ...
    Mail.text = NSLocalizedString(@"E-Mail：office@swedxscreens.co.uk",@"");
...
//    mainPage.backgroundColor = [UIColor cyanColor];
    ...
    Adress.frame = CGRectMake(KscreenWidth/2, CGRectGetMaxY(Mail.frame)+10, KscreenWidth/2 - 20, KscreenHeight/14);
    Adress.textColor = [UIColor colorWithRed:153/255.0 green:156/255.0 blue:158/255.0 alpha:1];
    Adress.numberOfLines = 2;
    Adress.text = NSLocalizedString(@"Address：Unit 41-42 Block 7 Old Mill Lane Industrial Estate Mansfield NG19 9BG",@"");
